...
if __name__=='__main__':
    ...
    config['data_root'] = '/ssd1/holdenhu/Amazon2014_dataset/Amazon_Phone/'
    meta_df = pd.read_csv('/ssd1/holdenhu/Amazon2014_dataset/Amazon_Phone/raw/core_meta_Cell_Phones_and_Accessories.csv')
