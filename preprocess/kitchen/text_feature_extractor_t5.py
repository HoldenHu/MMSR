...
if __name__=='__main__':
    ...
    config['data_root'] = '/ssd1/holdenhu/Amazon2014_dataset/Amazon_Kitchen/'
    meta_df = pd.read_csv('/ssd1/holdenhu/Amazon2014_dataset/Amazon_Kitchen/raw/core_meta_Home_and_Kitchen.csv')
