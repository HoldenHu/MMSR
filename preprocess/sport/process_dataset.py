...
if __name__=='__main__':
    # down load the file from # http://jmcauley.ucsd.edu/data/amazon/links.html
    config = build_config('../../config/preprocess.yaml')
    dataset_type = config['dataset_type']
    config['data_root'] = '/ssd1/holdenhu/Amazon2014_dataset/Amazon_Sport'
    config['ratingdf_path'] = '/ssd1/holdenhu/Amazon2014_dataset/Amazon_Sport/raw/ratings_Sports_and_Outdoors.csv'
